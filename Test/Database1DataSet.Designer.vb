...
Partial Public Class Database1DataSet
    ...
    Partial Public Class usertableDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Overloads Function AddusertableRow(ByVal Id As Integer, ByVal userName As String, ByVal password As String, ByVal fullName As String, ByVal role As String, ByVal pending As String, ByVal birthDate As String, ByVal age As Integer) As usertableRow
            Dim rowusertableRow As usertableRow = CType(Me.NewRow,usertableRow)
            Dim columnValuesArray() As Object = New Object() {Id, userName, password, fullName, role, pending, birthDate, age}
        ...
        Private Sub InitClass()
            ...
            Me.columnpending.AllowDBNull = false
    ...
    Partial Public Class usertableRow
        ...
        Public Property role() As String
            Get
                Return CType(Me(Me.tableusertable.roleColumn),String)
            End Get
            Set
                Me(Me.tableusertable.roleColumn) = value
            End Set
        End Property
        ...
        Public Property pending() As String
            Get
                Return CType(Me(Me.tableusertable.pendingColumn),String)
            End Get
            Set
                Me(Me.tableusertable.pendingColumn) = value
            End Set
        End Property
        ...
        Public Property birthDate() As String
            Get
                Return CType(Me(Me.tableusertable.birthDateColumn),String)
            End Get
            Set
                Me(Me.tableusertable.birthDateColumn) = value
            End Set
        End Property
        ...
        Public Property age() As Integer
            Get
                Return CType(Me(Me.tableusertable.ageColumn),Integer)
            End Get
            Set
                Me(Me.tableusertable.ageColumn) = value
            End Set
        End Property
    End Class
...
Namespace Database1DataSetTableAdapters
    ...
    Partial Public Class usertableTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[usertable] WHERE (([Id] = @Original_Id) AND ([userName] = @Ori"& _ 
                "ginal_userName) AND ([fullName] = @Original_fullName) AND ([role] = @Original_ro"& _ 
                "le) AND ([pending] = @Original_pending) AND ([birthDate] = @Original_birthDate) "& _ 
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_pending", Global.System.Data.SqlDbType.VarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "pending", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[usertable] ([Id], [userName], [password], [fullName], [role], "& _ 
                "[pending], [birthDate], [age]) VALUES (@Id, @userName, @password, @fullName, @ro"& _ 
                "le, @pending, @birthDate, @age);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Id, userName, password, fullName, role,"& _ 
                " pending, birthDate, age FROM usertable WHERE (Id = @Id)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[usertable] SET [Id] = @Id, [userName] = @userName, [password] = @pa"& _ 
                "ssword, [fullName] = @fullName, [role] = @role, [pending] = @pending, [birthDate"& _ 
                "] = @birthDate, [age] = @age WHERE (([Id] = @Original_Id) AND ([userName] = @Ori"& _ 
                "ginal_userName) AND ([fullName] = @Original_fullName) AND ([role] = @Original_ro"& _ 
                "le) AND ([pending] = @Original_pending) AND ([birthDate] = @Original_birthDate) "& _ 
                "AND ([age] = @Original_age));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Id, userName, password, fullName, role, pe"& _ 
                "nding, birthDate, age FROM usertable WHERE (Id = @Id)"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_pending", Global.System.Data.SqlDbType.VarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "pending", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.Test.My.MySettings.Default.Database1ConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Id, userName, password, fullName, role, pending, birthDate, age FROM dbo.u"& _ 
                "sertable"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As Database1DataSet.usertableDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As Database1DataSet.usertableDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As Database1DataSet.usertableDataTable = New Database1DataSet.usertableDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As Database1DataSet.usertableDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Id As Integer, ByVal Original_userName As String, ByVal Original_fullName As String, ByVal Original_role As String, ByVal Original_pending As String, ByVal Original_birthDate As String, ByVal Original_age As Integer) As Integer
            ...
            End If
            If (Original_pending Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_pending")
            Else
                Me.Adapter.DeleteCommand.Parameters(4).Value = CType(Original_pending,String)
            End If
            If (Original_birthDate Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_birthDate")
            Else
                Me.Adapter.DeleteCommand.Parameters(5).Value = CType(Original_birthDate,String)
            End If
        ...
        Public Overloads Overridable Function Insert(ByVal Id As Integer, ByVal userName As String, ByVal password As String, ByVal fullName As String, ByVal role As String, ByVal pending As String, ByVal birthDate As String, ByVal age As Integer) As Integer
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(5).Value = CType(pending,String)
            End If
        ...
        Public Overloads Overridable Function Update(ByVal Id As Integer, ByVal userName As String, ByVal password As String, ByVal fullName As String, ByVal role As String, ByVal pending As String, ByVal birthDate As String, ByVal age As Integer, ByVal Original_Id As Integer, ByVal Original_userName As String, ByVal Original_fullName As String, ByVal Original_role As String, ByVal Original_pending As String, ByVal Original_birthDate As String, ByVal Original_age As Integer) As Integer
            ...
            If (pending Is Nothing) Then
                Throw New Global.System.ArgumentNullException("pending")
            Else
                Me.Adapter.UpdateCommand.Parameters(5).Value = CType(pending,String)
            End If
            If (birthDate Is Nothing) Then
                Throw New Global.System.ArgumentNullException("birthDate")
            Else
            ...
            If (Original_pending Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_pending")
            Else
                Me.Adapter.UpdateCommand.Parameters(12).Value = CType(Original_pending,String)
            End If
            If (Original_birthDate Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_birthDate")
            Else
                Me.Adapter.UpdateCommand.Parameters(13).Value = CType(Original_birthDate,String)
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal userName As String, ByVal password As String, ByVal fullName As String, ByVal role As String, ByVal pending As String, ByVal birthDate As String, ByVal age As Integer, ByVal Original_Id As Integer, ByVal Original_userName As String, ByVal Original_fullName As String, ByVal Original_role As String, ByVal Original_pending As String, ByVal Original_birthDate As String, ByVal Original_age As Integer) As Integer
            Return Me.Update(Original_Id, userName, password, fullName, role, pending, birthDate, age, Original_Id, Original_userName, Original_fullName, Original_role, Original_pending, Original_birthDate, Original_age)
        End Function
    End Class
